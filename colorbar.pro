; David Fanning's ColorBar Program... from original viewer program.
; JRS 8/17/2012
...
RANGE=range, FONT=font, TICKLEN=ticklen,ylog=ylog, xtitle=xtitle,$
              ytitle=ytitle,ytickv=ytickv,_EXTRA=_extra
...
IF KEYWORD_SET(vertical) THEN BEGIN
   ...
   IF KEYWORD_SET(right) THEN BEGIN
      ...
      PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=1, $
         ...
         YRANGE=[minrange, maxrange], FONT=font, ytickv=ytickv,_EXTRA=extra, YMINOR=minor,ylog=ylog
      ...
      AXIS, YAXIS=1, YRANGE=[minrange, maxrange], YTICKFORMAT=format, YTICKS=divisions, $
         ...
         FONT=font, YTITLE=title, _EXTRA=extra, YMINOR=minor,ylog=ylog,ytickv=ytickv
   ENDIF ELSE BEGIN

      PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=1, $
         YTICKS=divisions, XSTYLE=1, YSTYLE=9, YMINOR=minor, $
         POSITION=position, COLOR=color, CHARSIZE=charsize, /NOERASE, $
         YTICKFORMAT=format, XTICKFORMAT='(A1)', YTICKLEN=ticklen , ylog=ylog,$
         YRANGE=[minrange, maxrange], FONT=font, YTITLE=title, ytickv=ytickv,_EXTRA=extra

      AXIS, YAXIS=1, YRANGE=[minrange, maxrange], YTICKFORMAT='(A1)', YTICKS=divisions, ytickv=ytickv,$
         YTICKLEN=ticklen, YSTYLE=1, COLOR=color, CHARSIZE=charsize, $
...
ENDIF ELSE BEGIN
   ...
   IF KEYWORD_SET(top) THEN BEGIN
      ...
      PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=divisions, $
         YTICKS=1, XSTYLE=9, YSTYLE=1, ylog=ylog,$
         POSITION=position, COLOR=color, CHARSIZE=charsize, /NOERASE, $
         YTICKFORMAT='(A1)', XTICKFORMAT='(A1)', XTICKLEN=ticklen, $
         XRANGE=[minrange, maxrange], FONT=font, _EXTRA=extra, XMINOR=minor,xtickv=ytickv
      ...
      AXIS, XTICKS=divisions, XSTYLE=1, COLOR=color, CHARSIZE=charsize, $
         ...
         FONT=font, XTITLE=title, _EXTRA=extra, XCHARSIZE=charsize, XMINOR=minor,ylog=ylog,xtickv=ytickv
   ENDIF ELSE BEGIN

      PLOT, [minrange,maxrange], [minrange,maxrange], /NODATA, XTICKS=divisions, $
         YTICKS=1, XSTYLE=1, YSTYLE=1, TITLE=title, xtitle=xtitle,ytitle=ytitle,$
         POSITION=position, COLOR=color, CHARSIZE=charsize, /NOERASE, $
         YTICKFORMAT='(A1)', XTICKFORMAT=format, XTICKLEN=ticklen, ylog=ylog,$
         XRANGE=[minrange, maxrange], FONT=font, XMinor=minor, xtickv=ytickv,_EXTRA=extra
